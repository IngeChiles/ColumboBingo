...
final class ColumboBingoTests: XCTestCase {
    ...
    func testButtonTapCallsAlert() {
        // test that within buttonTap(), when containsWinningCombination() is called and the result is true, bingoAlert() is called.
    ...
    func testCheckCombination() {
        ...
        let didWin = subject.containsWinningCombination(tappedIndices: subject.tappedIndices, winningIndices: subject.winningIndices)
